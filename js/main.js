(function ($) {
    ...
    function subpages_resize() {
        window.requestAnimationFrame(() => {
            var subpagesHeight = $('.pt-page-current').outerHeight(true);
    ...
    $(document).on('ready', function () {
        ...
        // Substituindo DOMSubtreeModified por MutationObserver
        const targetNode = document.querySelector(".subpages");
        if (targetNode) {
            const observer = new MutationObserver(subpages_resize);
